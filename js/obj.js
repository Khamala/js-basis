...
// Есть массив друзей, где каждый из друзей - это сущность и он описан объектом.И практически все во фронте -
// это массив объектов. Список холодильников на розетке,
...
// Если бы в этом массиве были числа или строки, то в переменную friend записалась бы копия.
// Поэтому мы в массивах использовали for если нужно изменить элемент массива и for...of если не нужно.

// Помните, что в массиве сложных типов при переборе через for of вы получаете в переменной на каждой итерации не копию, 
// а ссылку на этот объект и именно поэтому вы можете его изменять - Добавить какое-то свойство, убрать, перезаписать
*/
